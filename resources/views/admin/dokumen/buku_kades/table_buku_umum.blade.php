<div class="box box-info">
    <div class="box-header with-border">
        ...
        <a href="#confirm-delete" class="btn btn-social btn-danger btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block hapus-terpilih" title="Hapus Data"
            onclick="deleteAllBox('mainform', '{{ ci_route('dokumen_sekretariat.delete_all', ['kat' => $kat]) }}')"><i class='fa fa-trash-o'></i> Hapus</a>
        @endif
        <a
            href="{{ ci_route('dokumen_sekretariat.dialog_cetak', ['kat' => $kat, 'aksi' => 'cetak']) }}"
...
<script>
    $(document).ready(function() {
        ...
        var TableData = $('#tabeldata').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ ci_route('dokumen_sekretariat.datatables') }}",
                data: function(req) {
