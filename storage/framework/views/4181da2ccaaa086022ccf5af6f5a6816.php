                ...
                <form id="mainform" action="<?php echo e(site_url('program_bantuan/impor')); ?>" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <br />
                            <a target="_blank" href="<?php echo e(site_url('unduh/' . encrypt('assets/import/format_impor_program_bantuan.xlsx'))); ?>" class="btn btn-social bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block text-center"><i
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\OpenSID-2501.0.0\OpenSID-2501.0.0\resources\views/admin/layouts/components/program_bantuan/impor.blade.php ENDPATH**/ ?>